...
/// Usage: relego exclude remove highlight|book|author &lt;id&gt;
/// </summary>
public sealed class ExcludeRemoveCommand(RelegoHttpClient client, ILogger<ExcludeRemoveCommand> logger)
