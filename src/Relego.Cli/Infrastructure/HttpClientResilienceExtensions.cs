...
/// <summary>
/// Registers Polly resilience pipeline for the Relego HTTP client.
/// </summary>
public static class HttpClientResilienceExtensions
{
    public static IHttpClientBuilder AddRelegoResilience(this IHttpClientBuilder builder)
    {
        builder.AddResilienceHandler("relego-retry", pipeline =>
        {
