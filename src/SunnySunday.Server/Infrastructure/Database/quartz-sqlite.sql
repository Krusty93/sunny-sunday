...
-- Adapted from: https://github.com/quartznet/quartznet/blob/main/database/tables/tables_sqlite.sql
-- Changes: removed DROP TABLE statements; added IF NOT EXISTS for idempotent startup.
